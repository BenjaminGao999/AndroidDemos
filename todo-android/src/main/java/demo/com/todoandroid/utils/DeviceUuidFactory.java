...
import demo.com.todoandroid.constants.CommonConstants;
    ...
    public static UUID getUuid(Context context) {
        if (uuid == null) {
            synchronized (DeviceUuidFactory.class) {
                if (uuid == null) {
                    final String id = SpUtils.getString(context, CommonConstants.NET_KEY_DEVICE_ID, null);
                    if (id != null) {
                        ...
                        SpUtils.putString(context, CommonConstants.NET_KEY_DEVICE_ID, uuid.toString());
                    }
                }
            }
        }
